...
//        userPhoneEditText = (EditText) findViewById(R.id.settings_phone_number);
        ...
        securityBtn = findViewById(R.id.setting_security_btn);
    ...
    private void updateOnlyUserInfo() {
        DatabaseReference ref = FirebaseDatabase.getInstance("https://ecommerce-87169-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference().child("Users");
...
//                        userMap.put("phoneOrder", userPhoneEditText.getText().toString());
    ...
    private void userInfoDisplay(CircleImageView profileImageView, EditText fullNameEditText, EditText userPhoneEditText, EditText addressEditText) {
        DatabaseReference UsersRef = FirebaseDatabase.getInstance("https://ecommerce-87169-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference().child("Users").child(Prevalent.currentOnlineUser.getPhone());
